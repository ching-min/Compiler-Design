...
struct SymNode* createVarNode( const char *name, int scope, struct PType *type ,int count);
struct SymNode* createParamNode( const char *name, int scope, struct PType *type ,int count);
//struct SymNode* createVarNode( const char *name, int scope, struct PType *type ); 
struct SymNode * createConstNode( const char *name, int scope, struct PType *pType, struct ConstAttr *constAttr ,int count);
struct SymNode *createFuncNode( const char *name, int scope, struct PType *pType, struct FuncAttr *params ,int count);
